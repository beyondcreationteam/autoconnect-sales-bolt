...
export function WhatIs() {
  ...
  return (
    <section id="what-is" className="py-20 lg:py-32 bg-brand-light" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          <div>
            <h2
              className={`text-3xl sm:text-4xl lg:text-5xl font-bold text-brand-black mb-6 transition-all duration-700 ${
            ...
            <p
              className={`text-lg text-gray-600 mb-6 transition-all duration-700 delay-100 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
            ...
            >
              <div className="bg-white rounded-xl p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Store className="w-6 h-6 text-brand-orange" />
                </div>
                <span className="text-lg font-medium text-brand-black">OEMs</span>
              </div>
              <div className="bg-white rounded-xl p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center flex-shrink-0">
                  <CarFront className="w-6 h-6 text-brand-orange" />
                </div>
                <span className="text-lg font-medium text-brand-black">Dealership</span>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mb-12">
          <h3
            className={`text-2xl sm:text-3xl font-bold text-brand-black mb-4 transition-all duration-700 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {painPoints.map((point, index) => (
            ...
            >
              ...
              <h4 className="text-xl font-semibold text-brand-black mb-2">{point.title}</h4>
