      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          <div>
            <AnimatedHeading
              effect="words"
              className="text-3xl sm:text-4xl lg:text-5xl font-normal text-brand-black mb-6"
            >
        ...
        <div className="text-center mb-12">
          <AnimatedHeading
            as="h3"
            effect="lines"
            className="text-2xl sm:text-3xl font-normal text-brand-black mb-4"
          >
        ...
        <Reveal effect="fade-up" stagger={0.15} className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {painPoints.map((point) => (
            <div
              key={point.key}
              className="bg-brand-light p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 group h-full"
            >
